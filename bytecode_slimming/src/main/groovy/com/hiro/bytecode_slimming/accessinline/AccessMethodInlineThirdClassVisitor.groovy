 ...
 * @author hongweiqiu
 */
class AccessMethodInlineThirdClassVisitor extends BaseClassVisitor {

    def TAG = 'AccessMethodInlineThirdClassVisitor'

    AccessMethodInlineThirdClassVisitor(int api) {
        super(api)
    }

    AccessMethodInlineThirdClassVisitor(int api, ClassVisitor cv) {
        super(api, cv)
    }
    ...
    FieldVisitor visitField(int access, String name, String desc, String signature, Object value) {
        ...
        accessMethodProcessor.methodInlineInfoMap.values().each { AccessMethodInfo accessMethodInfo ->
            ...
            if (!resultVisitor[0]
                    && AccessMethodInlineSecondClassVisitor.isSameField(accessMethodInfo.readFieldInfo, className, name, desc)) {
    ...
    MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        ...
        accessMethodProcessor.methodInlineInfoMap.values().each { AccessMethodInfo accessMethodInfo ->
            ...
            } else if (AccessMethodInlineSecondClassVisitor.isSameMethod(accessMethodInfo.invokeMethodInfo, className, name, desc)
